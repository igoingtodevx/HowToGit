...
import type { ChallengeDefinition, DemoScript, LessonDefinition, LessonId, LessonRuntimeDefinition, ScenarioDefinition } from './types';
...
export const lessonCatalog: readonly LessonRuntimeDefinition[] = Object.freeze(lessons.map((lesson) => {
  ...
  return { ...lesson, challenge, demo, scenario, validator, hints: { en: englishHints as [string, string, string], de: germanHints as [string, string, string] } };
}));
